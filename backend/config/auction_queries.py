...
BASEBALL_VALUE_QUERIES_CORE: list[str] = [
    ...
    'baseball card jersey auto',
    'baseball card auto /25',
    'baseball card auto /50',
    'baseball card auto /99',
    'baseball card /399',
    'baseball card /499',
    'baseball card pink refractor',
    'baseball card aqua refractor',
    'baseball card orange refractor',
    'baseball card green refractor',
    'baseball card purple refractor',
    'baseball card red refractor',
    'baseball card blue refractor',
    'baseball card patch auto /25',
    'baseball card SSP variation',
    'baseball card image variation SP',
    'baseball card photo variation SP',
    'baseball card mojo refractor',
    'baseball card raywave refractor',
    'baseball card lava refractor',
    'baseball card speckle refractor',
    'baseball card wave refractor',
    'baseball card shimmer',
    'baseball card printing plate 1/1',
    ...
    'topps diamond icons baseball',
    'topps definitive baseball',
...
_BASEBALL_PRODUCT_LINE_TEMPLATES: list[str] = [
    ...
    '{y} Topps Heritage baseball',
    '{y} Topps Bowman Best baseball',
    '{y} Panini Prizm baseball',
    '{y} Panini Select baseball',
    '{y} Panini Mosaic baseball',
    '{y} Topps Chrome Update baseball',
    '{y} Bowman Draft baseball',
    '{y} Topps Gilded Collection baseball',
]
